...
void ft_callback(const geometry_msgs::WrenchStamped::ConstPtr& msg2) {

force.z = msg2->wrench.force.z; //줄여야됨
...
int main(int argc, char ** argv) 
{
  ...
  ros::Subscriber ft_sub = nh.subscribe("/netft_data/", 10, ft_callback);
